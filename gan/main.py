...
if __name__ == "__main__":
    ...
    p.add_argument('--batch_size', type=int, default=32, 
            help='Assumes discriminator actually sees 2x this per step')
    p.add_argument('--gauss_prior_size', type=int, default=100,
            help='The dimension of the Gaussian prior')
    ...
    p.add_argument('--test_cols', type=int, default=20,
            help='When testing MNIST, how many rows in our windows')
